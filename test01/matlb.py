...
#                "lng",
#                "lat"]
# file_path='D:/work2/kc_house_data.csv'
# # train = pd.read_csv(file_path,names=train_names)
# # print(train.info())
#
# train = pd.read_csv(file_path,names=train_names,parse_dates=["sales_time","yearbuilt",'yearremodadd'],dtype=float)
#
# # print(train.sales_price.describe())
# # print(train.sales_price,type(train.sales_price))
#
#
# # plt.figure(figsize = (10,5))
# # sns.distplot(train['sales_price'])
# # pl.show()  # 显示绘制出的图
#
# print('哈哈啊')
# import sys
...
#     demo()
#     x =[i for i in range(10)] + [1.5 * i for i in range(5)]
